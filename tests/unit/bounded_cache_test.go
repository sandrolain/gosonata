...
func TestBoundedCache_New(t *testing.T) {
	c := cache.New(10)
	if got := c.Len(); got != 0 {
...
func TestBoundedCache_DefaultCapacity(t *testing.T) {
	c := cache.New(0)
...
func TestBoundedCache_Miss(t *testing.T) {
	c := cache.New(4)
...
func TestBoundedCache_SetUpdate(t *testing.T) {
	c := cache.New(4)
...
func TestBoundedCache_FIFOEviction(t *testing.T) {
	c := cache.New(3)
...
func TestBoundedCache_FIFOEviction_Stats(t *testing.T) {
	c := cache.New(2)
	expr, _ := parser.Compile("$.x")
	c.Set("a", expr)
	c.Set("b", expr)
...
func TestBoundedCache_Invalidate(t *testing.T) {
	c := cache.New(4)
	expr, _ := parser.Compile("$.x")
	c.Set("k", expr)
	c.Invalidate("k")
...
func TestBoundedCache_InvalidateMissing(t *testing.T) {
	c := cache.New(4)
...
func TestBoundedCache_GetOrCompile(t *testing.T) {
	c := cache.New(4)
	calls := 0
...
func TestBoundedCache_ImplementsCacher(t *testing.T) {
...
func BenchmarkBoundedCache_Get(b *testing.B) {
	c := cache.New(256)
...
func BenchmarkBoundedCache_Get_Parallel(b *testing.B) {
	c := cache.New(256)
	expr, _ := parser.Compile("$.name")
	c.Set("$.name", expr)
	b.ResetTimer()
